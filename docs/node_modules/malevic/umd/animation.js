...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.Malevic = global.Malevic || {}, global.Malevic.Animation = {}), global.Malevic.DOM, global.Malevic.String));
    ...
    var malevicDOM__namespace = /*#__PURE__*/_interopNamespaceDefault(malevicDOM);
    var malevicString__namespace = /*#__PURE__*/_interopNamespaceDefault(malevicString);
    ...
    ***************************************************************************** */
    ...
    function withAnimation(type) {
        if (malevicDOM__namespace) {
            var domPlugins = malevicDOM__namespace.plugins;
            domPlugins.setAttribute.add(type, setAttributePlugin);
            domPlugins.setAttribute.add(type, setStyleAttributePlugin);
        }
        if (malevicString__namespace) {
            var stringPlugins = malevicString__namespace.plugins;
